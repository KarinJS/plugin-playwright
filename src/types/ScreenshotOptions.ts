 ...
 * 截图结果数据类型
 */
export type ScreenshotData<T extends Encoding> = T extends 'base64' ? string : Buffer
 ...
 * 截图参数
 */
export interface ScreenshotOptions extends Omit<PlaywrightScreenshotOptions, 'type'> {
